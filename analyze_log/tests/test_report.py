...
class TestReport(TestBase):
    ...
    def test_calculate_ip_num(self):
        ...
        exp_report = {'/coding/miniproject/material.html': {
            'ip_set': set(['200.200.76.130', '200.200.76.132']),
    ...
    def test_collect_ip_reports(self):
        ...
        self.assertIsInstance(ip_report, type(report.IPReports),
                              '返回文章类错误')
    ...
    def test_collect_complete_reports(self):
        ...
        self.assertIsInstance(complete_report, type(report.CompleteReports),
                              '返回完整报表类错误')
    ...
    def test_input_article_report(self):
        ...
        self.assertIsInstance(act_report, type(report.ArticleReports),
                              '文章报表初始化失败')
    ...
    def test_input_ip_report(self):
        ...
        self.assertIsInstance(act_report, type(report.IPReports),
                              'IP报表初始化失败')
    ...
    def test_input_complete_report(self):
        ...
        act_report = report._report(fake_data.log_list, report_type)
        self.assertIsInstance(act_report, type(report.CompleteReports),
                              '完整报表初始化失败')
